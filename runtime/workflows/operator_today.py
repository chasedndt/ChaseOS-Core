...
def _render_markdown_brief_v2(summary: dict) -> str:
    ...
    lines = [
        ...
        "",
        "> Source: `00_HOME/Now.md` · `ROADMAP.md` · active Project-OS files",
        "",
    ...
    lines.extend([
        "### Build Activity",
        "> Source: `07_LOGS/Build-Logs/` (last 5 files by modification time)",
    ])
    ...
    lines.extend(["", "### Quarantine Queue", "> Source: `03_INPUTS/`"])
    ...
    lines.extend(["", "### Recent Decisions", "> Source: `07_LOGS/Decision-Ledger/Index.md`"])
